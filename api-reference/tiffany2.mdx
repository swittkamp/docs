...
## Change Mag Card Status

To change the **Status** of a Mag Card to **Active**, you must also select a **Card Type** and make an **Association** selection.

<Note>
  - The Status of a Mag Card can be changed to Inactive from Active at any time.
  - The Status of a Mag Card can be changed to Active from Inactive at any time.
  - The Status of a Mag Card can be changed to Damaged from Active or Inactive at any time.
  - The Status of a Mag Card can be changed to Active or Inactive from Damaged at any time.
</Note>

## Change Mag Card Type
